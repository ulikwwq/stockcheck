...
public class SaleItem {
    ...
    public SaleItem(Product product, int quantity, BigDecimal purchasePrice, BigDecimal salePrice) {
        ...
        // Profit is only calculable when BOTH prices are known - never invent
        // either side (e.g. treat a missing price as 0).
        this.profit = (purchasePrice != null && salePrice != null)
